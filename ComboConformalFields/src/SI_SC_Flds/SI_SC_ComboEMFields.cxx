...
~SI_SC_ComboEMFields()
{
  if(m_ECntrFields != NULL) delete m_ECntrFields;
  if(m_MCntrFields != NULL) delete m_MCntrFields;

  if(m_ECPMLFields != NULL) delete m_ECPMLFields;
  if(m_MCPMLFields != NULL) delete m_MCPMLFields;
  if(m_EMurFields != NULL) delete m_EMurFields;
...
IsPhysDataMemoryLocated()
{
  ...
  if(result) cout<<"IsPhysDataMemoryLocated is ok"<<endl;
  else cout<<"IsPhysDataMemoryLocated is not ok"<<endl;
  return result;
}
